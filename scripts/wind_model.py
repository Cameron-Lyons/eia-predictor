...
wind = pd.read_csv("final_wind.csv").drop(["interconnect_long", "interconnect_short", "data_type", "date"], axis=1)
wind["DATE"] = pd.to_datetime(wind["LST_DATE"])
...
plt.plot(wind["DATE"], wind['generation'])
plt.plot(test["DATE"], preds)
plt.show()
